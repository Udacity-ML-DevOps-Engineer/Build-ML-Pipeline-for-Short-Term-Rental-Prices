...
def go(args):
    ...
    # fit the pipeline sk_pipe on the X_train, y_train data
    logger.info("Fitting")
    ...
    # save r_squared under the "r2" key and mae under the "mae" key
...
def get_inference_pipeline(rf_config, max_tfidf_features):
    ...
    # Build a pipeline with two steps. The first step is a SimpleImputer(strategy="most_frequent") to impute
    # missing values, and the second step is a OneHotEncoder() step to encode the variable
    ...
    # Create the inference pipeline with the preprocessor and the random forest
